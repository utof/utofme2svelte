<script>
    ...
    let snakeFrequency = 3;            // (Oscillation frequency)
  ...
  <main>
    ...
    <div class="controls">
      ...
      <div class="control-section">
        ...
        <input id="nodeRepulsion" class="control-input" type="range" min="0" max="100000" step="1000" bind:value={nodeRepulsionStrength} />
        <span>{nodeRepulsionStrength}</span>
      </div>
      <div class="control-section">
        <label class="param-label" for="nodeThreshold">Node Repulsion Threshold (10-500):</label>
        <input id="nodeThreshold" class="control-input" type="range" min="10" max="500" step="10" bind:value={nodeThreshold} />
        <span>{nodeThreshold}</span>
      </div>
      <div class="control-section">
        <label class="param-label" for="dampingFactor">Damping Factor (0.5-1):</label>
        <input id="dampingFactor" class="control-input" type="range" min="0.5" max="1" step="0.01" bind:value={dampingFactor} />
        <span>{dampingFactor}</span>
      </div>
      <div class="control-section">
        <label class="param-label" for="curveThreshold">Curve Repulsion Threshold (10-200):</label>
        <input id="curveThreshold" class="control-input" type="range" min="10" max="200" step="5" bind:value={curveRepulsionThreshold} />
        <span>{curveRepulsionThreshold}</span>
      </div>
      <div class="control-section">
        <label class="param-label" for="curveStrength">Curve Repulsion Strength (0-2):</label>
        <input id="curveStrength" class="control-input" type="range" min="0" max="2" step="0.01" bind:value={curveRepulsionStrength} />
        <span>{curveRepulsionStrength}</span>
      </div>
      <div class="control-section">
        <label class="param-label" for="offsetScale">Offset Scale (0-5):</label>
        <input id="offsetScale" class="control-input" type="range" min="0" max="5" step="0.01" bind:value={offsetScale} />
